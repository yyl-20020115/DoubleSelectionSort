...
int HorizontalMin16(__m512i data, short* p) {
	const int stride = sizeof(data) / sizeof(*p);
	const int half = stride >> 1;
	short lv = 0;
	short hv = 0;
...
int HorizontalMax16(__m512i data, short* p) {
	const int stride = sizeof(data) / sizeof(*p);
	const int half = stride >> 1;
	short lv = 0;
	short hv = 0;
...
int HorizontalMin8(__m512i data, char* p) {
	const int stride = sizeof(data) / sizeof(*p);
	const int half = stride >> 1;
	char lv = 0;
	char hv = 0;
...
int HorizontalMax8(__m512i data, char* p) {
	const int stride = sizeof(data) / sizeof(*p);
	const int half = stride >> 1;
	char lv = 0;
	char hv = 0;
...
int HorizontalMin32(__m512i data, int* p)
{
	const int stride = sizeof(data) / sizeof(*p);
	const int half = stride >> 1;
	int lv = 0;
...
int HorizontalMax32(__m512i data, int* p)
{
	const int stride = sizeof(data) / sizeof(*p);
	const int half = stride >> 1;
	int lv = 0;
...
int HorizontalMin64(__m512i data, long long* p)
{
	const int stride = sizeof(data) / sizeof(*p);
	const int half = stride >> 1;
	long long lv = 0;
...
int HorizontalMax64(__m512i data, long long* p)
{
	const int stride = sizeof(data) / sizeof(*p);
	const int half = stride >> 1;

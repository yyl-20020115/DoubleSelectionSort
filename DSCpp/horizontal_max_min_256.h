...
int HorizontalMin16(__m128i data, short* p = 0);
int HorizontalMax16(__m128i data, short* p = 0);
int HorizontalMin16(__m256i data, short* p = 0);
int HorizontalMax16(__m256i data, short* p = 0);
int HorizontalMin8(__m128i data, char* p = 0);
int HorizontalMax8(__m128i data, char* p = 0);
int HorizontalMin8(__m256i data, char* p = 0);
int HorizontalMax8(__m256i data, char* p = 0);
int HorizontalMin32(__m128i data, int* p = 0);
int HorizontalMax32(__m128i data, int* p = 0);
int HorizontalMin32(__m256i data, int* p = 0);
int HorizontalMax32(__m256i data, int* p = 0);
int HorizontalMin64(__m128i data, long long* p = 0);
int HorizontalMax64(__m128i data, long long* p = 0);
int HorizontalMin64(__m256i data, long long* p = 0);
int HorizontalMax64(__m256i data, long long* p = 0);

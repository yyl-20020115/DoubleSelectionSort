...
__m128i HorizontalSort8(__m128i data, char* pmin, char* pmax) {
	const int stride = sizeof(data) / sizeof(*pmin);
	__m128i result = { 0 };
	char min = 0;
	char max = 0;
...
__m256i HorizontalSort8(__m256i data, char* pmin, char* pmax) {
	const int stride = sizeof(data) / sizeof(*pmin);
	__m256i result = { 0 };
	char min = 0;
	char max = 0;
...
__m128i HorizontalSort16(__m128i data, short* pmin, short* pmax) {
	const int stride = sizeof(data) / sizeof(*pmin);
	__m128i result = { 0 };
	short min = 0;
	short max = 0;
...
__m256i HorizontalSort16(__m256i data, short* pmin, short* pmax) {
	const int stride = sizeof(data) / sizeof(*pmin);
	__m256i result = { 0 };
	short min = 0;
	short max = 0;
...
__m128i HorizontalSort32(__m128i data, int* pmin, int* pmax) {
	const int stride = sizeof(data) / sizeof(*pmin);
	__m128i result = { 0 };
	int min = 0;
	int max = 0;
...
__m256i HorizontalSort32(__m256i data, int* pmin, int* pmax) {
	const int stride = sizeof(data) / sizeof(*pmin);
	__m256i result = { 0 };
	int min = 0;
	int max = 0;
...
__m128i HorizontalSort64(__m128i data, long long* pmin, long long* pmax) {
	const int stride = sizeof(data) / sizeof(*pmin);
	__m128i result = { 0 };
...
__m256i HorizontalSort64(__m256i data, long long* pmin, long long* pmax) {
	const int stride = sizeof(data) / sizeof(*pmin);
	__m256i result = { 0 };
	long long min = 0;
	long long max = 0;
